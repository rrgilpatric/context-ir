...
_RUNTIME_PROBE_REFLECTIVE_GETATTR_BOUNDARY_TEXT = "getattr(obj, name)"
...
_RUNTIME_PROBE_REFLECTIVE_GETATTR_INT_BIT_LENGTH_SOURCE_END_COLUMN = 29
...
_RUNTIME_PROBE_REFLECTIVE_GETATTR_INT_BIT_LENGTH_SNAPSHOT_KIND = "eval_fixture"
...
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_BOUNDARY_TEXT = "getattr(obj, name, default)"
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SUBJECT_ID = "unsupported:call:main.py:2:11"
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_START_LINE = 2
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_START_COLUMN = 11
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_END_LINE = 2
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_END_COLUMN = 38
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_REPLAY_TARGET_SEED = "main.probe_attribute"
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_REPLAY_SELECTOR_SEED = (
    "call:main.probe_attribute:reflective_builtin:getattr/3@main.py:2:11:2:38"
)
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_MISSING_ATTRIBUTE_SNAPSHOT_KIND = (
    "eval_fixture"
)
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_MISSING_ATTRIBUTE_SNAPSHOT_ID = (
    "oracle_signal_getattr_default_probe@default-local-python:v1"
)
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_VALUE_ATTRIBUTE_SNAPSHOT_KIND = "eval_fixture"
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_VALUE_ATTRIBUTE_SNAPSHOT_ID = (
    "oracle_signal_getattr_default_value_probe@default-local-python:v1"
)
_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_MISSING_ATTRIBUTE_NAME = "missing_attribute"
_RUNTIME_PROBE_REFLECTIVE_VARS_LOCAL_PYTHON_FORM_LABEL = "reflective_builtin:vars/1"
_RUNTIME_PROBE_REFLECTIVE_VARS_BOUNDARY_TEXT = "vars(obj)"
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SUBJECT_ID = "unsupported:call:main.py:2:11"
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_START_LINE = 2
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_START_COLUMN = 11
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_END_LINE = 2
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_END_COLUMN = 20
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_REPLAY_TARGET_SEED = "main.probe_namespace"
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_REPLAY_SELECTOR_SEED = (
    "call:main.probe_namespace:reflective_builtin:vars/1@main.py:2:11:2:20"
)
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SNAPSHOT_KIND = "eval_fixture"
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SNAPSHOT_ID = (
    "oracle_signal_vars_type_error_probe@default-local-python:v1"
)
_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_OBJECT_TYPE = "builtins.int"
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SUBJECT_ID = (
    "unsupported:call:main.py:7:11"
)
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_START_LINE = 7
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_START_COLUMN = 11
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_END_LINE = 7
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_END_COLUMN = 20
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_REPLAY_TARGET_SEED = (
    "main.probe_namespace"
)
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_REPLAY_SELECTOR_SEED = (
    "call:main.probe_namespace:reflective_builtin:vars/1@main.py:7:11:7:20"
)
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SNAPSHOT_KIND = "eval_fixture"
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SNAPSHOT_ID = (
    "oracle_signal_vars_probe@default-local-python:v1"
)
_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_OBJECT_TYPE = "main.ProbeRecord"
...
_RUNTIME_PROBE_REFLECTIVE_DIR_BOUNDARY_TEXT = "dir(obj)"
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SUBJECT_ID = "unsupported:call:main.py:2:11"
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_START_LINE = 2
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_START_COLUMN = 11
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_END_LINE = 2
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_END_COLUMN = 19
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_REPLAY_TARGET_SEED = "main.probe_directory"
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_REPLAY_SELECTOR_SEED = (
    "call:main.probe_directory:reflective_builtin:dir/1@main.py:2:11:2:19"
)
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SNAPSHOT_KIND = "eval_fixture"
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SNAPSHOT_ID = (
    "oracle_signal_dir_probe@default-local-python:v1"
)
_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_OBJECT_TYPE = "builtins.int"
...
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_BOUNDARY_TEXT = (
    "setattr(obj, name, value)"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SUBJECT_ID = (
    "unsupported:call:main.py:7:4"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_START_LINE = 7
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_START_COLUMN = 4
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_END_LINE = 7
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_END_COLUMN = 29
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_REPLAY_TARGET_SEED = (
    "main.probe_set_attribute"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_REPLAY_SELECTOR_SEED = (
    "call:main.probe_set_attribute:runtime_mutation:setattr/3@main.py:7:4:7:29"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SNAPSHOT_KIND = "eval_fixture"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SNAPSHOT_ID = (
    "oracle_signal_setattr_probe@default-local-python:v1"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_OBJECT_TYPE = "main.ProbeTarget"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_ATTRIBUTE_NAME = "flag"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_ASSIGNED_VALUE_TYPE = "builtins.str"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_ASSIGNED_VALUE_LITERAL = "ready"
...
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_SOURCE_START_LINE = 7
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_SOURCE_START_COLUMN = 4
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_SOURCE_END_LINE = 7
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_SOURCE_END_COLUMN = 31
...
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_OBJECT_TYPE = "main.ProbeTarget"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_ATTRIBUTE_NAME = "flag"
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_ASSIGNED_VALUE_TYPE = (
    "builtins.str"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_LITERAL_FLAG_ASSIGNED_VALUE_LITERAL = "ready"
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_LOCAL_PYTHON_FORM_LABEL = (
    "runtime_mutation:delattr/2"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_BOUNDARY_TEXT = "delattr(obj, name)"
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SUBJECT_ID = (
    "unsupported:call:main.py:7:4"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_FILE_PATH = "main.py"
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_START_LINE = 7
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_START_COLUMN = 4
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_END_LINE = 7
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_END_COLUMN = 22
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_REPLAY_TARGET_SEED = (
    "main.probe_delete_attribute"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_REPLAY_SELECTOR_SEED = (
    "call:main.probe_delete_attribute:runtime_mutation:delattr/2@main.py:7:4:7:22"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SNAPSHOT_KIND = "eval_fixture"
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SNAPSHOT_ID = (
    "oracle_signal_delattr_probe@default-local-python:v1"
)
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_OBJECT_TYPE = "main.ProbeTarget"
_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_ATTRIBUTE_NAME = "flag"
...
_EXACT_REPLAY_GETATTR_NAME_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="reflective_builtin:getattr/2:name-variable-bit_length",
    family_label=RuntimeProbeFamily.REFLECTIVE_BUILTIN,
...
_EXACT_REPLAY_GETATTR_DEFAULT_MISSING_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="reflective_builtin:getattr/3:name-variable-missing-default",
    family_label=RuntimeProbeFamily.REFLECTIVE_BUILTIN,
    form_label=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_LOCAL_PYTHON_FORM_LABEL,
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SUBJECT_ID,
    reason_code=UnresolvedReasonCode.REFLECTIVE_BUILTIN,
    boundary_text=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_BOUNDARY_TEXT,
    source_file_path=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_FILE_PATH,
    source_start_line=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_START_LINE,
    source_start_column=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_START_COLUMN,
    source_end_line=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_END_LINE,
    source_end_column=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SOURCE_END_COLUMN,
    replay_target_seed=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_REPLAY_TARGET_SEED,
    replay_selector_seed=(
        _RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_REPLAY_SELECTOR_SEED
    ),
    replay_payload_fields=(
        ...
        (
            "attribute_name",
            _RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_MISSING_ATTRIBUTE_NAME,
        ),
    ),
)
_EXACT_REPLAY_GETATTR_DEFAULT_VALUE_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="reflective_builtin:getattr/3:name-variable-bit_length-default",
    family_label=RuntimeProbeFamily.REFLECTIVE_BUILTIN,
    form_label=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_LOCAL_PYTHON_FORM_LABEL,
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_SUBJECT_ID,
...
_EXACT_REPLAY_SETATTR_NAME_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="runtime_mutation:setattr/3:name-variable-flag",
    ...
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SUBJECT_ID,
    reason_code=UnresolvedReasonCode.RUNTIME_MUTATION,
    boundary_text=_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_BOUNDARY_TEXT,
    source_file_path=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_FILE_PATH
    ),
    source_start_line=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_START_LINE
    ),
    source_start_column=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_START_COLUMN
    ),
    source_end_line=(_RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_END_LINE),
    source_end_column=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SOURCE_END_COLUMN
    ),
    replay_target_seed=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_REPLAY_TARGET_SEED
    ),
    ...
    replay_payload_fields=(
        (
            "object_type",
            _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_OBJECT_TYPE,
        ),
        (
            "attribute_name",
            _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_ATTRIBUTE_NAME,
        ),
        (
            "assigned_value_type",
            _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_ASSIGNED_VALUE_TYPE,
        ),
        (
            "assigned_value_literal",
            _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_ASSIGNED_VALUE_LITERAL,
        ),
    ),
)
...
_EXACT_REPLAY_DELATTR_NAME_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="runtime_mutation:delattr/2:name-variable-flag",
    family_label=RuntimeProbeFamily.RUNTIME_MUTATION,
    form_label=_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_LOCAL_PYTHON_FORM_LABEL,
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SUBJECT_ID,
    reason_code=UnresolvedReasonCode.RUNTIME_MUTATION,
    boundary_text=_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_BOUNDARY_TEXT,
    source_file_path=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_FILE_PATH
    ),
    source_start_line=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_START_LINE
    ),
    source_start_column=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_START_COLUMN
    ),
    source_end_line=(_RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_END_LINE),
    source_end_column=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SOURCE_END_COLUMN
    ),
    replay_target_seed=(
        _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_REPLAY_TARGET_SEED
    ),
    ...
    replay_payload_fields=(
        (
            "object_type",
            _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_OBJECT_TYPE,
        ),
        (
            "attribute_name",
            _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_ATTRIBUTE_NAME,
        ),
    ),
)
...
_EXACT_REPLAY_DIR_INT_DIRECTORY_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="reflective_builtin:dir/1:int-directory",
    family_label=RuntimeProbeFamily.REFLECTIVE_BUILTIN,
    form_label=_RUNTIME_PROBE_REFLECTIVE_DIR_LOCAL_PYTHON_FORM_LABEL,
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SUBJECT_ID,
    reason_code=UnresolvedReasonCode.REFLECTIVE_BUILTIN,
    boundary_text=_RUNTIME_PROBE_REFLECTIVE_DIR_BOUNDARY_TEXT,
    source_file_path=_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_FILE_PATH,
    source_start_line=(_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_START_LINE),
    source_start_column=(
        _RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_START_COLUMN
    ),
    source_end_line=_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_END_LINE,
    source_end_column=_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SOURCE_END_COLUMN,
    replay_target_seed=_RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_REPLAY_TARGET_SEED,
    replay_selector_seed=(
        _RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_REPLAY_SELECTOR_SEED
    ),
    replay_payload_fields=(
        (
            "object_type",
            _RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_OBJECT_TYPE,
        ),
    ),
)
_EXACT_REPLAY_VARS_TYPE_ERROR_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="reflective_builtin:vars/1:type-error-int",
    family_label=RuntimeProbeFamily.REFLECTIVE_BUILTIN,
    form_label=_RUNTIME_PROBE_REFLECTIVE_VARS_LOCAL_PYTHON_FORM_LABEL,
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SUBJECT_ID,
    reason_code=UnresolvedReasonCode.REFLECTIVE_BUILTIN,
    boundary_text=_RUNTIME_PROBE_REFLECTIVE_VARS_BOUNDARY_TEXT,
    source_file_path=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_FILE_PATH,
    source_start_line=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_START_LINE,
    source_start_column=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_START_COLUMN,
    source_end_line=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_END_LINE,
    source_end_column=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SOURCE_END_COLUMN,
    replay_target_seed=_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_REPLAY_TARGET_SEED,
    replay_selector_seed=(
        _RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_REPLAY_SELECTOR_SEED
    ),
    replay_payload_fields=(
        (
            "object_type",
            _RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_OBJECT_TYPE,
        ),
    ),
)
_EXACT_REPLAY_VARS_RETURNED_NAMESPACE_CONTRACT = _RuntimeProbeExactReplayContract(
    contract_id="reflective_builtin:vars/1:probe-record-namespace",
    family_label=RuntimeProbeFamily.REFLECTIVE_BUILTIN,
    form_label=_RUNTIME_PROBE_REFLECTIVE_VARS_LOCAL_PYTHON_FORM_LABEL,
    subject_kind=SemanticSubjectKind.UNSUPPORTED_FINDING,
    subject_id=_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SUBJECT_ID,
    reason_code=UnresolvedReasonCode.REFLECTIVE_BUILTIN,
    boundary_text=_RUNTIME_PROBE_REFLECTIVE_VARS_BOUNDARY_TEXT,
    source_file_path=(
        _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_FILE_PATH
    ),
    source_start_line=(
        _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_START_LINE
    ),
    source_start_column=(
        _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_START_COLUMN
    ),
    source_end_line=(_RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_END_LINE),
    source_end_column=(
        _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SOURCE_END_COLUMN
    ),
    replay_target_seed=(
        _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_REPLAY_TARGET_SEED
    ),
    ...
    replay_payload_fields=(
        (
            "object_type",
            _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_OBJECT_TYPE,
        ),
    ),
)
...
_RUNTIME_PROBE_EXACT_REPLAY_CONTRACT_SNAPSHOT_SCOPES: tuple[
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        contract=_EXACT_REPLAY_GETATTR_NAME_CONTRACT,
        repository_snapshot_kind=(
            _RUNTIME_PROBE_REFLECTIVE_GETATTR_INT_BIT_LENGTH_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
            _RUNTIME_PROBE_REFLECTIVE_GETATTR_INT_BIT_LENGTH_SNAPSHOT_ID
        ),
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        contract=_EXACT_REPLAY_GETATTR_DEFAULT_MISSING_CONTRACT,
        repository_snapshot_kind=(
            _RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_MISSING_ATTRIBUTE_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        contract=_EXACT_REPLAY_GETATTR_DEFAULT_VALUE_CONTRACT,
        repository_snapshot_kind=(
            _RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_VALUE_ATTRIBUTE_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
            _RUNTIME_PROBE_REFLECTIVE_GETATTR_DEFAULT_VALUE_ATTRIBUTE_SNAPSHOT_ID
        ),
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        contract=_EXACT_REPLAY_SETATTR_NAME_CONTRACT,
        repository_snapshot_kind=(
            _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
            _RUNTIME_PROBE_RUNTIME_MUTATION_SETATTR_NAME_FLAG_SNAPSHOT_ID
        ),
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        contract=_EXACT_REPLAY_DELATTR_NAME_CONTRACT,
        repository_snapshot_kind=(
            _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
            _RUNTIME_PROBE_RUNTIME_MUTATION_DELATTR_NAME_FLAG_SNAPSHOT_ID
        ),
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        ...
        repository_snapshot_kind=(
            _RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
            _RUNTIME_PROBE_REFLECTIVE_DIR_INT_DIRECTORY_SNAPSHOT_ID
        ),
    ...
    _RuntimeProbeExactReplayContractSnapshotScope(
        ...
        repository_snapshot_kind=(
            _RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(_RUNTIME_PROBE_REFLECTIVE_VARS_TYPE_ERROR_SNAPSHOT_ID),
    ),
    _RuntimeProbeExactReplayContractSnapshotScope(
        contract=_EXACT_REPLAY_VARS_RETURNED_NAMESPACE_CONTRACT,
        repository_snapshot_kind=(
            _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SNAPSHOT_KIND
        ),
        repository_snapshot_id=(
            _RUNTIME_PROBE_REFLECTIVE_VARS_RETURNED_NAMESPACE_SNAPSHOT_ID
        ),
...
def _is_reflective_getattr_int_bit_length_probe_request(
    ...
    """Return whether a request is an exact accepted ``getattr`` replay path."""
    contract = _runtime_probe_exact_replay_contract_for_request(request)
    return contract in (
        _EXACT_REPLAY_GETATTR_NAME_CONTRACT,
        _EXACT_REPLAY_GETATTR_ATTRIBUTE_ERROR_CONTRACT,
