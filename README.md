...
existing quad matrix. This evidence does not cover builtins alias support,
bare `__import__(name)` expansion, shadowed/rebound/aliased forms,
...
builtins-attribute `builtins.__import__(name)` sibling evidence. The
