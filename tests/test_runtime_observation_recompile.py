...
def test_default_local_python_subprocess_recompile_helper_observes_exact_hasattr(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The default helper carries exact hasattr replay inputs into the worker."""
    ...
    recompile_application = result.result_batch_recompile_application
    attempt = collection.attempts[0]
    runner_request = collection.runner_request_batch.runner_requests[0]
    observed_result = collection.result_batch.results[0]
    admission = recompile_application.observation_application.admissions[0]
    recompiled_boundary = _boundary_for(
        recompile_application.recompile_result.diagnostic,
...
def test_default_local_python_subprocess_recompile_helper_observes_literal_hasattr(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The default helper observes only exact direct-literal hasattr replay input."""
    ...
    recompile_result = recompile_application.recompile_result
...
def test_default_local_python_subprocess_recompile_helper_observes_literal_getattr(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The default helper observes only exact direct-literal getattr replay input."""
...
def test_default_local_python_subprocess_recompile_helper_observes_literal_delattr(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The default helper observes only exact direct-literal delattr replay input."""
...
def test_default_local_python_subprocess_recompile_helper_observes_literal_setattr(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The default helper observes only exact direct-literal setattr replay input."""
