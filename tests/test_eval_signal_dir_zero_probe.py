...
def test_dir_zero_probe_default_subprocess_provider_fails_closed() -> None:
    """The exact subprocess provider does not add dir-zero task support."""
    ...
    assert "oracle_signal_dir_zero_probe" not in message
